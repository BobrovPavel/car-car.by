...
def parse_ad(next_data: dict) -> dict:
    ...
    #   2) userName — то, что kufar показывает в шапке профиля
    #      ('ООО АГРОЩИТ', 'RespectАвто') — для юрлиц это название компании
    #   3) name в accountParams — официальное юрлицо ('ООО ...') как последний фолбэк
    # contactPerson НЕ участвует — это имя менеджера ('Александр'), а не компании.
    ...
    return {
        ...
        "contact_person":  _ap(acp, "contactPerson") if is_company else None,
